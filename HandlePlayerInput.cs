...
public class HandlePlayerInput : MonoBehaviour
{
 ...
 // Update is called once per frame
    ...
    private void HandleMouseClick()
    {
        ...
        GameObject selectedObject = collider == null ? null : collider.gameObject; //collider can be null or referencing the agent. if colider = null, it will be null, else get collider.getobject.
